...
function check_program {
  ...
  expected_version=$2
  version_command=$3
  actual_version=$(eval $version_command 2>/dev/null | head -1)
  echo -n "checking $program_name version... "
...
#             Program        Expected version     Version command
...
check_program "vim"          "Vi IMproved 7.4"    "vim --version"
...
check_program "unzip"        "UnZip 6."           "unzip"
